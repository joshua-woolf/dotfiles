...
config.keys = {
  { action = wezterm.action { SendString = "\001" },                          mods = '',          key = "Home", },
  { action = wezterm.action { SendString = "\005" },                          mods = '',          key = "End", },
  { action = wezterm.action { SendString = "\x1bb" },                         key = "LeftArrow",  mods = "OPT", },
  { action = wezterm.action { SendString = "\x1bf" },                         key = "RightArrow", mods = "OPT", },
